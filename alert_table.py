...
logging.basicConfig(filename='log_app.log', level=logging.INFO, format='%(asctime)s %(levelname)s: %(message)s')
...
try:
    ...
    try: 
        ...
        ctx = connect ( 
        user = 'PYTHON_USER', 
        password = os.environ.get('SNOWFLAKE_PYTHON_USER'),  
    ...
    to = 'doliu@gatelesis.com' # recipient of the email 
